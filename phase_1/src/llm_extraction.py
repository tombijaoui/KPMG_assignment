...
def _draft_slice_for_refinement(
    draft: dict[str, Any], shape: dict[str, Any]
) -> dict[str, Any]:
...
def _coerce_refinement_response_to_focus_shape(
    refined: dict[str, Any], shape: dict[str, Any]
) -> dict[str, Any]:
...
def _call_llm_refinement(
    client: AzureOpenAI,
    model_name: str,
    focus_schema: dict[str, Any],
    draft_focus_slice: dict[str, Any],
    ocr_text: str,
) -> dict[str, Any]:
