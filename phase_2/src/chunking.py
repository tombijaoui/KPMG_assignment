...
class KnowledgeChunk:
    ...
    def to_store_dict(self) -> dict[str, Any]:
        """Serialize for disk (vectors live in the FAISS index file)."""
        return {
            "chunk_id": self.chunk_id,
            "text": self.text,
            "metadata": self.metadata,
...
def build_embedded_chunks(html_dir: Path | None = None) -> list[KnowledgeChunk]:
    """Parse HTML knowledge files and embed all chunks."""
    chunks = scrape_html_directory(html_dir)
